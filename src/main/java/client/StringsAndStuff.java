...
public class StringsAndStuff {
    ...
    public static final String F_H ="(multivalue): EQU_ENDS\t - filter results out that are (backwards) identicall with the word beeing queried(works not with --REV_IPA_SEARCH) EX: Word to QUERY: <Haus>, <Bootshaus> would be filtered out\n"+
                                    "PLURALS\t";
    public static final String MF_H= "add / remove multiple Filters Options";
    ...
    public static final String E_H = "Meta-Option: sets Client-Options to exportAll to Database. Overrides the specific Options";
